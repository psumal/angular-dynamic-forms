...
var CONTROL_ACCESSOR = {
    ...
    useExisting: core_1.forwardRef(function () { return FormatterParserDirective; }),
    multi: true
};
var FormatterParserDirective = (function () {
    ...
    FormatterParserDirective.prototype.onControlInput = function ($event) {
        ...
        //write value to view
        input.value = this.formatterParserView.reduce(function (state, transform) { return transform(state); }, value);
    ...
    FormatterParserDirective.prototype.writeValue = function (value) {
        ...
        input.value = this.formatterParserView.reduce(function (state, transform) { return transform(state); }, value);
        //write value to model
        var modelValue = this.formatterParserModel.reduce(function (state, transform) { return transform(state); }, value);
