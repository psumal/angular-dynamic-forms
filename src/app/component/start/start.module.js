...
var changeSubscriptions_1 = require("../../common/reactive-utils/changeSubscriptions");
var ui_components_token_1 = require("../../common/dymanic-form-element/ui-components.token");
var filteredOptionsSubscription_1 = require("../../common/dynamic-form-addons/change-subscriptions/filteredOptionsSubscription");
var dynamic_form_module_1 = require("../../common/dynamic-form/dynamic-form.module");
var ui_basic_module_1 = require("../../common/ui-basic/ui-basic.module");
var slider_component_1 = require("../../common/dynamic-form-addons/components/slider/slider.component");
...
var controlMatchValidator_1 = require("../../common/dynamic-form-addons/validators/controlMatchValidator");
var dividableByValidator_1 = require("../../common/dynamic-form-addons/validators/dividableByValidator");
var promiseValidator_1 = require("../../common/dynamic-form-addons/asyncValidators/promiseValidator");
var observableValidator_1 = require("../../common/dynamic-form-addons/asyncValidators/observableValidator");
var randomlValidator_1 = require("../../common/dynamic-form-addons/validators/randomlValidator");
var someOfValidator_1 = require("../../common/dynamic-form-addons/validators/someOfValidator");
var formatterParser_1 = require("../../common/dynamic-form/injects/formatterParser");
var maskString_1 = require("../../common/dynamic-form-addons/formatter-parser/maskString");
var replaceString_1 = require("../../common/dynamic-form-addons/formatter-parser/replaceString");
var toCapitalized_1 = require("../../common/dynamic-form-addons/formatter-parser/toCapitalized");
...
StartModule = __decorate([
    core_1.NgModule({
        ...
        providers: [
            ...
            { provide: changeSubscriptions_1.CHANGE_SUBSCRIPTIONS, useValue: filteredOptionsSubscription_1.filteredOptions, multi: true },
