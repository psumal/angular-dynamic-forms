...
var ui_components_token_1 = require("../dynamic-form/components/ui-components.token");
...
UiBasicModule = __decorate([
    core_1.NgModule({
        ...
        providers: [
            ...
            { provide: ui_components_token_1.UI_COMPONENTS, useValue: item_formGroup_component_1.FormGroupComponent, multi: true },
